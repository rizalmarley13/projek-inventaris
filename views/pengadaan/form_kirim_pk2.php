...
<div class="row">
	...
	<P><?php echo $this->session->flashdata('info') ?></P>
		...
		<tr>
			<td>
				<div class="col-md-3">
				<input type="hidden" name="kirim_ke" value="PK II Bidang Keuangan">
				</div>
			</td>
		</tr>
		<tr>
			<td>
			<div>
			&nbsp;&nbsp;&nbsp;<button type="submit" class="btn btn-primary btn-small"><span class="fa fa-send fa-fw"></span> Kirim Ke PK II</button>
			</div>
			</td>
		</tr>
		</table>
