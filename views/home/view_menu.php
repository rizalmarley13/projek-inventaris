...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">SiMi STT-BANDUNG</a>
            </div>
            <!-- /.navbar-header -->
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo base_url();?>index.php/barang2">Data Barang</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url();?>index.php/ruangan">Data Ruangan</a>
                                </li>
                                 <li>
                                    <a href="<?php echo base_url();?>index.php/pengadaan/tampil_datapengadaan">Data Pengadaan</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url();?>index.php/mutasi">Data Mutasi</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url();?>index.php/letak_barang">Data Letak Barang</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url();?>index.php/maintenance">Data Maintenance</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
